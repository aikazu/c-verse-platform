...
export function ensureSeed() {
  ...
  store.badges = [
    {
      ...
      code: "first_drop",
      name: "First Drop",
      description: "Beli pertama kali",
      icon: "🎴",
      iconUrl: "🎴",
      xp: 100,
      xpReward: 100,
      criteria: { type: "collect_count", min: 1 },
      isActive: true,
    },
    {
      id: "b2",
    ...
    },
    {
      ...
      code: "curator",
      name: "Curator",
      description: "10 kartu kreator sama",
      icon: "🎨",
      iconUrl: "🎨",
      xp: 300,
      xpReward: 300,
      criteria: { type: "creator_cards", min: 10 },
      isActive: true,
    },
    {
      id: "b5",
      code: "whale",
      name: "Whale",
      description: "Single bid > 100 C-Coin",
      icon: "🐋",
      iconUrl: "🐋",
      xp: 500,
      xpReward: 500,
      criteria: { type: "single_bid_gt", min: 100 },
      isActive: true,
    },
    {
      id: "b6",
  ...
  const demoUsers: User[] = [
    {
      id: "u_demo",
      email: "demo@cverse.id",
      passwordHash: "demo123",
      displayName: "Demo Kolektor",
      username: "demo_kolektor",
      role: "user",
      avatarUrl: null,
      xp: 45,
      totalXp: 45,
      level: 5,
      cumulativeSpendCcoin: 30,
      isAnonymous: false,
      flagReason: null,
    ...
    {
      id: "cr_hype",
      email: "hype@creator.id",
      passwordHash: "x",
      displayName: "HypeCreator",
      username: "hypecreator",
      role: "creator",
      avatarUrl: null,
      xp: 90,
      totalXp: 90,
  ...
  for (const u of demoUsers) {
    ...
    store.wallets.set(u.id, {
      userId: u.id,
      balanceCCoin: u.id === "u_demo" ? 120 : u.id === "cr_karina" ? 0 : 50,
      totalTopupCCoin: u.id === "u_demo" ? 150 : 0,
      totalSpentCCoin: u.id === "u_demo" ? 30 : 0,
  ...
  store.creators.set("cr-karina", {
    id: "cr-karina",
    userId: "cr_karina",
    handle: "karina_aespa",
    totalFollowersCombined: 185000,
    status: "active",
    bankAccount: { bank: "BCA", account_no: "1234567890", holder: "Karina" },
    notes: "Rekrut via DM IG",
    createdAt: nowIso(),
  });
  store.creators.set("cr-hype", {
    id: "cr-hype",
    userId: "cr_hype",
    handle: "hypecreator",
    totalFollowersCombined: 320000,
    status: "active",
    bankAccount: { bank: "Mandiri", account_no: "9876543210", holder: "HypeCreator" },
    notes: "Referral founder",
    createdAt: nowIso(),
  });
  store.creators.set("cr-nova", {
    id: "cr-nova",
    userId: "cr_nova",
    handle: "nova_studio",
    totalFollowersCombined: 110000,
    status: "active",
    bankAccount: { bank: "BCA", account_no: "1122334455", holder: "Nova Studio" },
  ...
  const drops: Drop[] = [
    {
      id: "drop-aespa-2025",
      title: "Karina — Limited Genesis",
      series: "HypeCreator X Aespa (2025 Limited Series)",
      narrative:
      ...
      artworkUrl: "/textures/karina.jpg",
      totalUnits: 15,
      signedCount: 2,
      unsignedCount: 13,
      ...
      priceCcoin: 30,
      status: "live",
      dropAt: new Date(Date.now() - 3600_000).toISOString(),
      dropStartAt: new Date(Date.now() - 3600_000).toISOString(),
      dropEndAt: null,
      creatorId: "cr_karina",
      creatorName: "Karina Aespa",
      soldCount: 6,
      createdAt: nowIso(),
    },
    {
      id: "drop-genesis-alpha",
      title: "Genesis Alpha",
      series: "Creator X — Alpha Series",
      ...
      signedCount: 2,
      unsignedCount: 18,
      priceUnsignedCCoin: 25,
      priceSignedCCoin: 45,
      priceCcoin: 25,
      status: "live",
      dropAt: new Date(Date.now() - 7200_000).toISOString(),
      dropStartAt: new Date(Date.now() - 7200_000).toISOString(),
      dropEndAt: null,
      creatorId: "cr_hype",
      creatorName: "HypeCreator",
      soldCount: 12,
      createdAt: nowIso(),
    },
    {
      id: "drop-nova-01",
      title: "Neon Bloom #01",
      series: "Nova Studio — Neon Bloom",
      narrative: "Neon Bloom mengeksplor gradien neon & organic shapes. Tiap kartu punya nomor seri & sertifikat digital.",
      artworkUrl: "/textures/neon.jpg",
      totalUnits: 12,
      signedCount: 2,
      unsignedCount: 10,
      priceUnsignedCCoin: 20,
      priceSignedCCoin: 40,
      priceCcoin: 20,
      status: "scheduled",
      dropAt: new Date(Date.now() + 86400_000 * 2).toISOString(),
      dropStartAt: new Date(Date.now() + 86400_000 * 2).toISOString(),
      dropEndAt: null,
      creatorId: "cr_nova",
    ...
    {
      id: "drop-aespa-signed",
      title: "Karina — Signed Vault",
      series: "HypeCreator X Aespa — Signed Vault",
      narrative: "Signed edition — ditandatangani kreator, insert premium, hanya 1 per 10 kartu.",
      artworkUrl: "/textures/karina-signed.jpg",
      totalUnits: 10,
      signedCount: 1,
      unsignedCount: 9,
      priceUnsignedCCoin: 30,
      ...
      priceCcoin: 30,
      status: "ended",
      dropAt: new Date(Date.now() - 86400_000 * 7).toISOString(),
      dropStartAt: new Date(Date.now() - 86400_000 * 7).toISOString(),
      dropEndAt: null,
      creatorId: "cr_karina",
      creatorName: "Karina Aespa",
      soldCount: 10,
    ...
    for (let i = 1; i <= d.totalUnits; i++) {
      ...
      const prefix =
        d.id
          .replace(/[^a-z0-9]/gi, "")
          .slice(-4)
          .toLowerCase() || d.id.slice(0, 4);
      const shortId = `${prefix}-${String(i).padStart(3, "0")}`;
      ...
      if (d.id === "drop-aespa-2025" && i === 3 && isSold) {
        status = "listed";
        buyout = 45;
        location = "with_owner";
      }
      if (d.id === "drop-genesis-alpha" && i === 2 && isSold) {
        status = "sold";
      ...
      const card: Card = {
        ...
        status,
        location,
        buyoutPriceCcoin: buyout,
        nfcConfigured: true,
        qcStatus: isSold ? "passed" : "pending",
        ownerId,
        nfcUid: uidHex,
        nfcShortId: shortId,
  ...
  store.walletTx.push(
    ...
    },
    {
      ...
      type: "topup",
      amountCCoin: 50,
      balanceAfterCCoin: 150,
      refType: "topup",
      refId: "top-2",
      note: "Top-up via VA BCA",
    ...
    },
    {
      ...
      type: "checkout",
      amountCCoin: -30,
      balanceAfterCCoin: 120,
      refType: "order",
      refId: "ord-demo",
      note: "Checkout Karina #03",
  ...
  const orderDemo: Order = {
    id: "ord-demo",
    userId: "u_demo",
    dropId: "drop-aespa-2025",
    cardIds: ["card-drop-aespa-2025-03"],
    cardId: "card-drop-aespa-2025-03",
    totalCCoin: 30,
    totalIdr: 30 * C_COIN_RATE_IDR,
    status: "shipped",
    deliveryOption: "shipping",
    shippingFeeCcoin: 2,
    escrowStatus: "held",
    shippingAddress: "Jl. Demo No. 1, Jakarta Selatan",
    trackingNumber: "JNE-881200334455",
    shippedAt: new Date(Date.now() - 30 * 60000).toISOString(),
    deliveredAt: null,
    createdAt: new Date(Date.now() - 3600_000).toISOString(),
  };
  ...
  const orderVault: Order = {
    id: "ord-vault-demo",
    userId: "u_demo",
    dropId: "drop-genesis-alpha",
    cardIds: ["card-drop-genesis-alpha-02"],
    cardId: "card-drop-genesis-alpha-02",
    totalCCoin: 25,
    totalIdr: 25 * C_COIN_RATE_IDR,
    status: "settled",
    deliveryOption: "vault",
    shippingFeeCcoin: null,
  ...
  store.shipments.set("ship-demo-1", {
    id: "ship-demo-1",
    cardId: "card-drop-aespa-2025-03",
    requesterId: "u_demo",
    type: "primary_shipping",
    fromLocation: "platform",
    toDest: "buyer_address",
    address: { street: "Jl. Demo No. 1, Jakarta Selatan" },
    feeCcoin: 2,
    status: "shipped",
    trackingNumber: "JNE-881200334455",
    createdAt: new Date(Date.now() - 3600_000).toISOString(),
  });
  store.shipments.set("ship-vault-1", {
    id: "ship-vault-1",
    cardId: "card-drop-genesis-alpha-02",
    requesterId: "u_demo",
    type: "primary_vault",
    fromLocation: "platform",
    toDest: "platform_vault",
    address: null,
    feeCcoin: null,
    status: "delivered",
    trackingNumber: null,
  ...
  store.ownershipHistory.push(
    {
      ...
      orderId: "ord-demo",
      bidId: null,
      transferredAt: new Date(Date.now() - 3600_000).toISOString(),
    },
    {
      id: "oh-vault-1",
      cardId: "card-drop-genesis-alpha-02",
      ownerId: "u_demo",
      acquiredVia: "primary",
      orderId: "ord-vault-demo",
      bidId: null,
      transferredAt: new Date(Date.now() - 86400_000 * 5).toISOString(),
    },
  );
  ...
  store.bids.push(
    {
      ...
      cardId: "card-drop-aespa-2025-03",
      bidderId: "u_admin",
      bidderName: "Admin C.Verse",
      amountCCoin: 38,
      status: "outbid",
      createdAt: new Date(Date.now() - 3600_000 * 5).toISOString(),
      outbidAt: new Date(Date.now() - 3600_000).toISOString(),
    },
    {
      id: uid("bid-"),
      cardId: "card-drop-aespa-2025-03",
      bidderId: "cr_hype",
      bidderName: "HypeCreator",
      amountCCoin: 42,
      status: "active",
      createdAt: new Date(Date.now() - 3600_000).toISOString(),
    },
  ...
  store.userBadges.push({
    userId: "u_demo",
    badgeId: "b1",
    earnedAt: new Date(Date.now() - 86400_000 * 2).toISOString(),
    awardedAt: new Date(Date.now() - 86400_000 * 2).toISOString(),
    xpRewardSnapshot: 100,
  });
}
...
export function ensureWallet(userId: string): Wallet {
  ...
  if (!w) {
    w = { userId, balanceCCoin: 0, totalTopupCCoin: 0, totalSpentCCoin: 0, holdPayoutUntil: null, updatedAt: nowIso() };
...
export function addTx(
  ...
  const tx: WalletTx = {
    ...
    type,
    amountCCoin,
    balanceAfterCCoin: w.balanceCCoin,
    refType,
    refId,
    note,
    createdAt: nowIso(),
...
export function evaluateBadges(userId: string) {
  ...
  const totalXp =
    (store.users.get(userId) as unknown as { totalXp?: number }).totalXp ?? (store.users.get(userId) as unknown as { xp?: number }).xp ?? 0;
  ...
  for (const def of store.badges.filter((b) => b.isActive !== false)) {
    ...
    if (t === "collect_count") ok = cardsOwned >= min;
      ...
      if (cid)
        ok = [...store.cards.values()].filter((c) => c.ownerId === userId && store.drops.get(c.dropId)?.creatorId === cid).length >= min;
...
export function cumulativeTopup(userId: string): number {
  ...
  return store.walletTx
    .filter((t) => t.userId === userId && (t.type === "topup" || t.type === "top_up") && t.amountCCoin > 0)
