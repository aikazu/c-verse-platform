...
vi.mock("../modules/gamification/reads.js", async (importOriginal) => {
  const mod = await importOriginal<typeof import("../modules/gamification/reads.js")>();
  return {
    ...mod,
