...
vi.mock("../../lib/auth.js", () => ({
  requireUser: () => Promise.resolve({
    user: { id: "user-1", email: "test@cverse.id", displayName: "Test", role: "user", username: null, usernameIsAuto: true, xp: 0, totalXp: 0, level: 1, cumulativeSpendCcoin: 0, isAnonymous: false, flagReason: null, consentAnalyticsDetail: false, consentDataMarket: false, createdAt: new Date().toISOString() },
    token: "mock-token",
  }),
}));
...
vi.mock("../../lib/reads/wallet.js", () => ({
  ...
  listWalletTxs: () => Promise.resolve([
    { id: "tx-1", userId: "user-1", type: "topup", amountCCoin: 100, balanceAfterCCoin: 200, refType: null, refId: null, note: null, createdAt: new Date().toISOString() },
  ]),
