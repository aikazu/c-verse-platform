-- Catalog and card inventory. The three artwork atlases are deliberately
-- reused across variants; every drop uses the single approved 3D placeholder.
...
insert into public.drops (
  ...
  ('drop-aespa-live','Karina: Eclipse','Karina Genesis','Live FCFS inventory after a completed raffle. Purchases settle to Vault.','/textures/karina.jpg','/placeholder.obj',8,1,7,30,50,30,'live',now()-interval '8 days',now()+interval '14 days',now()-interval '7 days',now()-interval '7 days','00000000-0000-4000-8000-000000000003','Karina Aespa',4,false,'00000000-0000-4000-8000-000000000002'),
  ...
  ('drop-aespa-signed','Karina: Signed Eclipse','Karina Genesis','Sold-out ten-card raffle; unit 10 is the signed winner.','/textures/karina.jpg','/placeholder.obj',10,1,9,30,50,30,'sold_out',now()-interval '11 days',now()-interval '9 days',now()-interval '10 days',now()-interval '10 days','00000000-0000-4000-8000-000000000003','Karina Aespa',10,false,'00000000-0000-4000-8000-000000000002'),
  ('drop-aespa-2027','Aurora: 2027 Preview','Aurora Archive','Scheduled preview which intentionally reuses the Aurora artwork atlas.','/mock/v1/artworks/aurora.png','/placeholder.obj',10,1,9,28,48,28,'scheduled',now()+interval '30 days',now()+interval '31 days',now()+interval '31 days',null,'00000000-0000-4000-8000-000000000005','Nova Studio',0,false,'00000000-0000-4000-8000-000000000002'),
  ('drop-genesis-beta','Genesis: Beta Draft','Genesis One','Draft drop for admin review and QC planning.','/mock/v1/artworks/genesis.png','/placeholder.obj',10,1,9,25,45,25,'draft',null,null,null,null,'00000000-0000-4000-8000-000000000004','Hype Collective',0,false,'00000000-0000-4000-8000-000000000002'),
  ...
  ('drop-seed-karina-01','Karina: Creator Seed Lock','Creator Seed C.Card','Phase one: accepted bid is locked while the physical card moves to Vault.','/textures/karina.jpg','/placeholder.obj',1,1,0,60,60,60,'live',now()-interval '30 days',null,null,null,'00000000-0000-4000-8000-000000000003','Karina Aespa',0,true,'00000000-0000-4000-8000-000000000002'),
  ('drop-seed-karina-02','Karina: Creator Seed Released','Creator Seed C.Card','Phase two: verified Vault card released to its buyer.','/textures/karina.jpg','/placeholder.obj',1,1,0,80,80,80,'closed',now()-interval '45 days',now()-interval '5 days',null,now()-interval '5 days','00000000-0000-4000-8000-000000000003','Karina Aespa',1,true,'00000000-0000-4000-8000-000000000002')
