...
| PG-BADGE-01 | `/badges` | Kabinet Prestasi | Galeri 43 lencana; delapan jalur x lima tingkat plus tiga khusus. Cari/filter, detail syarat + hadiah XP, contoh Bronze-Silver-Gold-Astral-Nova. Sesi pemilik membuka progres privat dan XP snapshot yang sudah diraih. Link dari Leaderboard/menu/profil; definisi nonaktif hanya terlihat jika sudah diraih. |
